...
sub_agents:
  ...
  sds:
    ...
    key_frameworks:
      - name: "NEPQ Methodology (Jeremy Miner)"
        phases: ["Connecting", "Situation", "Problem Awareness", "Solution Awareness", "Consequence", "Commitment"]
  ...
  sales-coordinator:
    ...
    key_frameworks:
      - name: "Application Grading System"
        grades: ["Grade 4: Best rep NOW", "Grade 3: Round robin", "Grade 2: Flag for review", "Grade 1: Reject"]
  ...
  sales-lead:
    ...
    key_frameworks:
      ...
      - name: "Coaching in Real-Time (5 Steps)"
        steps: ["Observe", "Note (max 2 points)", "Ask ('How do you think it went?')", "Add perspective", "Practice (role-play)"]
      - name: "Daily Routine"
  ...
  nepq-specialist:
    ...
    key_frameworks:
      ...
      - name: "7 Tonalities"
        tones: ["Curious", "Confused", "Concerned", "Challenging", "Direct", "Playful", "Empathetic"]
      - name: "3 Commitment Questions"
        questions: ["Do you feel this could be what you're looking for?", "Why do you feel it is though?", "What would you like to do from here?"]
...
# ============================================================================
dna_integration:
  constitution_reference: ".aios-core/core/protocols/constitution.yaml"
  agent_index_reference: ".aios-core/core/protocols/agent-index.yaml"

  knowledge_paths:
    cole-gordon: ".aios-core/data/knowledge/dna/cole-gordon/"
    alex-hormozi: ".aios-core/data/knowledge/dna/alex-hormozi/"
    jeremy-miner: ".aios-core/data/knowledge/dna/jeremy-miner/"
...
*AIOS Agent - Sales Squad - Migrated from Mega Brain*
