...
Atualiza MEMORY-THIAGO.md automaticamente.
...
def load_memory():
    """Carrega MEMORY-THIAGO.md atual."""
    project_dir = get_project_dir()
    memory_path = Path(project_dir) / '.claude' / 'jarvis' / 'MEMORY-THIAGO.md'
...
def update_memory_file(section, content):
    """Atualiza uma secao especifica do MEMORY-THIAGO.md."""
    project_dir = get_project_dir()
    memory_path = Path(project_dir) / '.claude' / 'jarvis' / 'MEMORY-THIAGO.md'
...
def log_update(update_type, content):
    ...
    project_dir = get_project_dir()
    log_path = Path(project_dir) / '06-LOGS' / 'memory_updates.jsonl'
